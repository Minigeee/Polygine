...
#define SHAPE_CAST(x) reinterpret_cast<reactphysics3d::ConvexMeshShape*>(x)
...
///////////////////////////////////////////////////////////
void ConvexMeshCollider::setScale(const Vector3f& scale)
{
...
///////////////////////////////////////////////////////////
void ConvexMeshCollider::setScale(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////
Vector3f ConvexMeshCollider::getScale() const
{
	ASSERT(m_shape, "The collider must be created using the physics scene extension");
