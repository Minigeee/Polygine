...
///////////////////////////////////////////////////////////
ConvexMeshCollider::ConvexMeshCollider(const Model& model, Uint32 mesh) :
	m_vertices			(0),
	m_indices			(0),
	m_numVertices		(0),
	m_numUniqueVertices	(0)
...
///////////////////////////////////////////////////////////
void ConvexMeshCollider::setModel(const Model& model, Uint32 mesh)
{
...
///////////////////////////////////////////////////////////
void ConvexMeshCollider::setVertices(const std::vector<Vertex>& vertices, const std::vector<Uint32>& indices)
{
...
///////////////////////////////////////////////////////////
Uint32 ConvexMeshCollider::getNumVertices() const
{
...
///////////////////////////////////////////////////////////
Uint32 ConvexMeshCollider::getNumUniqueVertices() const
{
...
///////////////////////////////////////////////////////////
Vertex* ConvexMeshCollider::getVertices() const
{
	return m_vertices;
}
...
///////////////////////////////////////////////////////////
Uint32* ConvexMeshCollider::getIndices() const
{
	return m_indices;
}
